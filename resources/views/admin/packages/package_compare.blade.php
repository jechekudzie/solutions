            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"> {{$serviceCategory->name}}</h4>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/packages/'.$serviceCategory->id.'/index')}}"
                ...
                <div class="col-xxl-12">
                    <div class="card" id="companyList">
                        <div style="color: black;font-size: 18px;font-weight: bolder;" class="card-header">
                            Compare: {{$serviceCategory->name}}
                        </div>


                        <div class="card-body form-steps">
                            <form class="vertical-navs-step" method="post"
                                  action="{{url('/admin/packages/'.$serviceCategory->id.'/confirm_values')}}"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="row gy-5">
                                    <div class="col-lg-12">
                                        <div class="row gy-3">
                                            @foreach($serviceCategory->packages as $package)
                                                        ...
                                                        <div class="card-body p-4 m-2">
                                                            ...
                                                            <div>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-grow-1">
                                                                        <h5 class="mb-1 fw-semibold">{{$package->name}} ({{$package->package_category->name}}) </h5>
                                                                ...
                                                                <div class="pt-4">
                                                                    <h2 style="font-size: 15px;">
                                                                        <sup><small>$</small></sup> {{$package->price}}
                                                                        <span
                                                            ...
                                                            <div>
                                                                <ul class="list-unstyled vstack gap-3 text-muted">
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        <li>
                                                                                            <div class="d-flex">
                                                                                                ...
                                                                                                <div
                                                                                                    class="flex-grow-1">
                                                                                                    ({{$package_essential_item->value}}){{$package_essential_item->essential_item->name}}
                                                                                                </div>
                                                                                            </div>
                                                                                        </li>
                                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <li>
                                                                                    <div class="d-flex">
                                                                                        ...
                                                                                        <div class="flex-grow-1">
                                                                                            {{$package_accessory->accessory->name}}
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </div>
                                                                    ...
                                                                    <li>
                                                                        <div class="d-flex">
                                                                            <div
                                                                                class="flex-shrink-0 text-danger me-1">
