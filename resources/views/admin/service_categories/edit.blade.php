                        ...
                        <div class="card-body">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content border-0">
                                    <form method="post"
                                          action="{{url('/admin/service_categories/'.$serviceCategory->id.'/update')}}"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <div>
                                                    ...
                                                    <select name="service_id" class="form-select rounded-pill mb-3"
                                                            aria-label="Default select example">
                                                        <option selected>Search for service</option>
                                                        @foreach($services as $service)
                                                            <option
                                                                value="{{$service->id}}" {{$serviceCategory->service_id == $service->id ?'selected':''}}>{{$service->name}}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-lg-6">
                                                <div>
                                                    ...
                                                    <input type="text" name="sku_increment"
                                                           class="form-control rounded-pill mb-3"
                                                           value="{{$serviceCategory->sku_increment}}" readonly
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    ...
                                                    <textarea name="description" class="editor form-control"
                                                              placeholder="Enter service description">{!! $serviceCategory->description !!}
                                                            </textarea>
                                                </div>
                                            </div>
