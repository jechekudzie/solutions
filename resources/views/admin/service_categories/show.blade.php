            ...
            <div class="row">
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                                        ...
                                        <div class="col-xxl-12">
                                            <div class="card border card-border-primary">
                                                <div class="card-header">
                                                    ...
                                                    <h6 class="card-title mb-0"> {{$serviceCategory->name}}
                                                ...
                                                <div class="card-body">
                                                    <div class="text-left">
                                                        <a href="{{url('/admin/service_categories/'.$serviceCategory.'/edit')}}" class="link-primary fw-medium">
                        ...
                        <form method="post" action="{{url('/admin/service_categories/'.$serviceCategory->id.'/destroy')}}"
