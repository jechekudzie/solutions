            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Eessentials</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item active">Eessentials</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                                        ...
                                        <div class="col-xxl-12">
                                            <div class="card border card-border-primary">
                                                <div class="card-header">
                                                    ...
                                                    <h6 class="card-title mb-0"> {{$essential->name}}
                        ...
                        <form method="post" action="{{url('/admin/essentials/'.$essential->id)}}"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel">Deelete</h5>
