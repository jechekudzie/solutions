                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <button class="btn btn-info add-btn" data-bs-toggle="modal"
                                            ...
                                            class="ri-add-fill me-1 align-bottom"></i> Add Essential
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive table-card mb-3">
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="name" scope="col">Essential</th>
                                        ...
                                        @foreach($essentials as $essential)
                                            <tr>
                                                ...
                                                <td class="owner">{{$essential->name}}</td>
                                                <td class="owner">{!! $essential->description !!}</td>
                                                <td class="industry_type">
                                                    <a href="{{url('/admin/essential_items/'.$essential->id.'/index')}}">
                                                       Essential items ({{$essential->essential_items->count()}})
                                                    </a>
                                                </td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="View">
                                                            <a href="{{url('/admin/essentials/'.$essential->id)}}"
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/essentials/'.$essential->id.'/edit')}}"><i
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        ...
                                        <form method="post" action="{{url('/admin/essentials')}}"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div>
                                                            ...
                                                            <input type="text" name="name"
                                                                   class="form-control rounded-pill mb-3" value="{{old('name')}}"
