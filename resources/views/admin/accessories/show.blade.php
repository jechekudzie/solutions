            ...
            <div class="row">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/accessories')}}" class="btn btn-info add-btn"><i
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                                        ...
                                        <div class="col-xxl-12">
                                            <div class="card border card-border-primary">
                                                <div class="card-header">
                                                    ...
                                                    <h6 class="card-title mb-0"> {{$accessory->name}}
                        ...
                        <form method="post" action="{{url('/admin/accessories/'.$accessory->id)}}"
