            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{$LineItemcategory->name}} items</h4>
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    ...
                                    <button class="btn btn-info add-btn" data-bs-toggle="modal"
                                            ...
                                            class="ri-add-fill me-1 align-bottom"></i> Add {{$LineItemcategory->name}} line items
                                    </button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        @foreach($lineItems as $lineItem)
                                            <tr>
                                                ...
                                                <td class="owner">{{$lineItem->LineItemcategory->name}}</td>
                                                <td>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        <div class="modal-header bg-soft-info p-3">
                                            <h5 class="modal-title" id="exampleModalLabel">{{$LineItemcategory->name}}</h5>
                                        ...
                                        <form method="post" action="{{url('/admin/line_items/store')}}"
                                            ...
                                            <div class="modal-body">
                                                <div class="row g-3">
                                                    ...
                                                    <input type="hidden" name="LineItemcategory_id"
                                                           class="form-control rounded-pill mb-3"
                                                           value="{{$LineItemcategory->id}}">
                                                    <div class="col-lg-12">
                                                        <div>
