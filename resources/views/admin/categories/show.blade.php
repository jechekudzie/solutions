            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Package category</h4>
            ...
            <div class="row">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/package_categories')}}" class="btn btn-info add-btn"><i
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                                        ...
                                        <div class="col-xxl-12">
                                            <div class="card border card-border-primary">
                                                <div class="card-header">
                                                    ...
                                                    <h6 class="card-title mb-0"> {{ $packageCategory->name}}
                        ...
                        <form method="post" action="{{url('/admin/package_categories/'. $packageCategory->id)}}"
